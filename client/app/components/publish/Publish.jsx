        ...
        return (
            <div className="publish">
                <Form>
                    <FormCell>
                        <CellBody>
                            <Input type="text" placeholder="标题" value={this.state.title} onChange={e=>this.setState({title: e.target.value})}/>
                        </CellBody>
                    </FormCell>

                    <FormCell>
                        <CellBody>
                            <TextArea placeholder="描述" rows="3" maxlength="200" value={this.state.description} onChange={e=>this.setState({description: e.target.value})}></TextArea>
                        </CellBody>
                    </FormCell>

                    <FormCell>
                        <CellBody>
                            <Input type="number" placeholder="价格(单位/元)" value={this.state.price} onChange={e=>this.setState({price: e.target.value})}  pattern="[0-9]*" max="1000000" min="1"/>
                        </CellBody>
                    </FormCell>
                    ...
                    <FormCell select selectPos="after">
                        ...
                        <CellBody>
                            <Select data={this.categoryList} value={this.state.category} onChange={e=>this.setState({category: e.target.value})}/>
                        </CellBody>
                    </FormCell>
                    ...
                    <FormCell select selectPos="after">
                        ...
                        <CellBody>
                            <Select data={this.tradeTypeList} value={this.state.tradeType} onChange={e=>this.setState({tradeType: e.target.value})}/>
                        </CellBody>
                    </FormCell>
